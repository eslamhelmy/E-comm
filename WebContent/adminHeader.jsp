										...
										<div class="facts">
											<div class="register">
												<form action="Uservlet" method="post">			
													<input placeholder="Name" name="uname" type="text" required="">
													<input placeholder="Email Address" name="email" type="email" required="">	
													<input placeholder="Password" name="psw" type="password" required="">	
													<input placeholder="Credit Card" name="cnum" type="text" required="">
													<br><br>
													<input placeholder="job" name="job" type="text" required="">
													<br><br>
													<input placeholder="birth date" name="bdate" type="text" required="">
													<div class="sign-up">
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav">
							...
							<!-- <ul class="dropdown-menu multi-column columns-3">
								<div class="row">
									...
									<div class="col-sm-3">
										<ul class="multi-column-dropdown">
											<h6>Edit</h6>
											<li><a href="products1.html">Edit</a></li>
									...
									<div class="col-sm-2">
										<ul class="multi-column-dropdown">
											<h6>Update</h6>
											<li><a href="products2.html">Update</a></li>
						...
						<li class="w3pages"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Categories <span class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="icons.html">Delete</a></li>
								<li><a href="codes.html">Add</a></li>
								<li><a href="icons.html">Update</a></li>     
							</ul>
						</li>  
						<li class="w3pages"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Users <span class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="icons.html">Delete</a></li>
								<li><a href="codes.html">View</a></li>
